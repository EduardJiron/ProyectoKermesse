...
<html lang="en">
    <head>
        ...
        <title>Gestión de tasa de cambio</title>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gestionar la tasa de cambio</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Index</a></li>
                            <li class="breadcrumb-item active">Gestión tasa de cambio </li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <table id="tbl_tasCam" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($dt->listTasaC() as $r):
                                        ?>

                                        <tr>
                                            <td>
                                        <?php echo $r->__GET("id_tasaCambio"); ?>
                                            </td>
                                            <td>
                                        <?php echo $r->__GET("mes"); ?>   
                                        </td> 
                                        <td>
...
$(document).ready( function (){
    ...
    }).buttons().container().appendTo('#tbl_tasCam_wrapper .col-md-6:eq(0)');
