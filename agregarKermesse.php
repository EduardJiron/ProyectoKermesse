                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Agreagar Kermesse</h3></div>
                                    <div class="card-body">
                                        <form>
                                        <div class="row mb-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="inputLastName">Fecha de Inicio</label>
                                                        <br>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating">
                                                        <input class="form-control" id="inputLastName" type="text" placeholder="Enter your last name" />
                                                        <label for="inputLastName">Fecha de Fin</label>
                                                        <br>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><a class="btn btn-primary btn-block" href="tblparroquia.php">Agregar Kermesse</a></div>
                                            </div>
                                        </form>
                                    </div>
