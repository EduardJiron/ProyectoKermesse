                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Editar Tasa Cambio</h3></div>
                                    <div class="card-body">
                                        <form>
                                        <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <option selected>Selecionar Tasa Cambio</option>
                                                    
                                                    <?php foreach ($dt->listTasaC() as $r):
                                                    ?>
                                   
                                        <option value="2"><?php echo $r->__GET("id_tasaCambio"); ?></option>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><a class="btn btn-primary btn-block" href="tbltasaCambio.php">Editar Cambio</a></div>
                                            </div>
                                        </form>
                                    </div>
