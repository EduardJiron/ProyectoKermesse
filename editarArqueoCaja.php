                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Editar Arqueo de Caja</h3></div>
                                    <div class="card-body">
                                        <form>
                                        <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <option selected>Selecionar Arqueo de Caja</option>
                                                    
                                                    <?php foreach ($dt->listArqueoC() as $r):
                                                    ?>
                                   
                                        <option value="2"><?php echo $r->__GET("id_ArqueoCaja"); ?></option>
                                        ...
                                        <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">Fecha de Arqueo</label>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">Gran Total</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><a class="btn btn-primary btn-block" href="tblArqueoCaja.php">Editar Arqueo</a></div>
                                            </div>
                                        </form>
                                    </div>
