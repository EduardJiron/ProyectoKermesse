                    ...
                    <div class="sb-sidenav-menu">
                        ...
                        <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                    ...
                                    <a class="nav-link" href="tblgastosdet.php">Detalle de datos</a>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Editar Kermesse</h3></div>
                                    <div class="card-body">
                                        <form>
                                        <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <option selected>Selecionar Kermesse</option>
                                                    
                                                    <?php foreach ($dt->listComunidad() as $r):
                                                    ?>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><a class="btn btn-primary btn-block" href="tblparroquia.php">Editar Kermesse</a></div>
                                            </div>
                                        </form>
                                    </div>
