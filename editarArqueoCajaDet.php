                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Editar Arqueo Caja Det</h3></div>
                                    <div class="card-body">
                                        <form>
                                        <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <option selected>Selecione el detalle de Arqueo Caja</option>
                                                    
                                                    <?php foreach ($dt->listArqueoCajaDet() as $r):
                                                    ?>
                                        ...
                                        <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">Subtotal</label>
                                                    </div>
                                                </div>
                                            </div>
