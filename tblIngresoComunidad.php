...
<html lang="en">
    <head>
        ...
        <title>Gestión de Ingresos de Comunidades </title>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gestionar los Ingresos de una comunidad</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Index</a></li>
                            <li class="breadcrumb-item active">Gestión de Ingresos de una comunidad</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                En esta pantalla se pueden visualizar y gestionar los ingresos de una nueva comunidad. 
                                Para crear el ingreso de una nueva comunidad por favor de clic en el botón: 
...
?>
                                        ...
                                        <td> <?php echo $r->__GET("total_bonos"); ?>    </td>             
                                            ...
                                            <td>
                                                ...
                                                <a href="editarIngresoComunidad.php" target="_blank" title="Modificar los ingresos de una comunidad ">
...
$(document).ready( function (){
    ...
    $("#tbl_ingreso_comunidad").DataTable({
    ...
    }).buttons().container().appendTo('#tbl_ingreso_comunidad_wrapper .col-md-6:eq(0)');
