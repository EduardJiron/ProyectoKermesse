                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Editar Ingreso de Comunidad Det</h3></div>
                                    <div class="card-body">
                                        <form>
                                        <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <option selected>Selecionar Ingreso de Comunidad Det</option>
                                                    
                                                    <?php foreach ($dt->listIngresoComunidadDet() as $r):
                                                    ?>
                                   
                                        <option value="2"><?php echo $r->__GET("id_ingreso_comunidad_det"); ?></option>
                                        ...
                                        <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">Agreagar Ingreso de Comunidad Det</label>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" />
                                                        <label for="inputFirstName">Denominación</label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="inputLastName">Subtotal Bono</label>
                                                        <br>
                                                    </div>
                                                </div>                                                
