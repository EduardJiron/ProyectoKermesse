...
<body class="sb-nav-fixed">
    ...
    <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop">
        <source src="assets/mp4/loop.mp4" type="video/mp4" />
    </video>
    <div class="mastheade">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" onclick="deleteopciones('<?php echo $r->__GET('id_opciones');  ?>');" title="Eliminar">
    ...
    <script>
        function deleteopciones(a) {
            confirm(function(e, btn) { //event + button clicked
                    e.preventDefault();
                    window.location.href = "./negocio/NgOpciones.php?delU=" + a;
