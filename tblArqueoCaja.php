...
<tbody>
    ...
    foreach ($dt->listArqueoC() as $r):
    ?>

    <tr>
        <td>
    <?php echo $r->__GET("id_ArqueoCaja"); ?>
        </td>
        <td>
    <?php echo $r->__GET("fecha_Arqueo"); ?>
    
        
    </td>
      
        <td>   <?php echo $r->__GET("gran_Total"); ?></td>
