...
<html lang="en">
    <head>
        ...
        <title>Gestión de Ingresos de una determinada Comunidad  </title>
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gestionar los Ingresos de una determinada comunidad</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Index</a></li>
                            <li class="breadcrumb-item active">Gestión de Ingresos de una determinada comunidad</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-table me-1"></i>
                                 Ingreso de una determinada comunidad
                            </div>
                            <div class="card-body">
...
$(document).ready( function (){
    ...
    $("#tbl_ingreso_comunidad_det").DataTable({
    ...
    }).buttons().container().appendTo('#tbl_ingreso_comunidad_det_wrapper .col-md-6:eq(0)');
