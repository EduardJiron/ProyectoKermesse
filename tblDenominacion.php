...
<html lang="en">
    <head>
        ...
        <title>Gestión de Denominacion de Monedas</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="principal.php">kerm</a>
            <!-- Sidebar Toggle-->
        ...
        <video class="bg-video" playsinline="playsinline" autoplay="autoplay" muted="muted" loop="loop"><source src=src="assets/mp4/loop.mp4" type="video/mp4" /></video>
        <div class="masthead">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gestionar las Denominaciones de las Monedas</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="index.php">Index</a></li>
                            <li class="breadcrumb-item active">Gestión de Denominaciones de Monedas</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                            ...
                            <div class="card-body">
                                <table id="tbl_denominacion" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($dt->listDenominacion() as $r):
                                        ?>

                                        <tr>
                                            <td>
                                        <?php echo $r->__GET("id_Denominacion"); ?>
                                            </td>
                                            <td>
                                        <?php echo $r->__GET("valor"); ?>
