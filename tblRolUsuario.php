...
include 'datos/DtRolUsuario.php';
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Gestionar roles de Usuarios</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                En esta pantalla se pueden visualizar y gestionar los roles de los usuarios activos/inactivos. 
                            ...
                            <div class="card-body">
                                ...
                                <label> 
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($dt->listRolUsuario() as $r):
                                        ?>
