                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Ingresar Opcion</h3>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-floating">
                                                    ...
                                                    <input class="form-control" id="opcion_descripcion" name="opcion_descripcion" type="text" placeholder="Enter your last name" />
