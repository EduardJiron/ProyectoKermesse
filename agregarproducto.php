                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Ingresar productos</h3></div>
                                    <div class="card-body">
                                        <form>
                                        <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <option selected>Seleciones comunidad</option>
                                                    
                                                    <?php foreach ($dtC->listComunidad() as $r):
                                                    ?>
                                        ...
                                        <option value="2"><?php echo $r->__GET("nombre"); ?></option>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <?php foreach ($dtCP-> listctgproducto()as $s):
                                                    ?>
                                   
                                        <option value="2"><?php echo $s->__GET("nombre"); ?></option>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><a class="btn btn-primary btn-block" href="login.html">Agregar producto</a></div>
                                            </div>
                                        </form>
                                    </div>
